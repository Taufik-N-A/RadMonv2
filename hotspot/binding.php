...
<h3><i class="fa fa-address-book"></i> Mac Binding<span style="font-size: 14px">
&nbsp; | &nbsp; <a href="../hotspot/addmac.php" title="Add User"><i class="fa fa-user-plus"></i> Add</a>
</span>  &nbsp;
...
<div class="input-group-4 col-box-4">
<select id="userstatus" name="userstatus" class="group-item group-item-m">
...
<div class="input-group-4 col-box-4">
    <select style="padding:5px;" class="group-item group-item-m" onchange="location = this.value; loader()" title="Filter by Profile">
        <option value="../hotspot/binding.php?status=<?php echo $status; ?>" <?php echo (!isset($_GET['planName']) ? 'selected' : ''); ?>>All Profile</option>
        <?php
        include ("../backend/macaddress.php");
        ...
        if ($resultCount->num_rows > 0) {
            while ($row = $resultCount->fetch_assoc()) {
                ...
                ?>
                <option value="../hotspot/binding.php?planName=<?php echo htmlspecialchars($planName); ?>&status=<?php echo $status; ?>" <?php echo $selected; ?>>
...
<tbody>
<?php include ('../include/hotspot.mac.php'); ?>
</div>
<script src="../js/radmon-ui.<?php echo $theme; ?>.min.js"></script>
<script src="../js/radmon.js"></script>
<script src="../plugins/mac.binding.js"></script>
</body>
</html>
